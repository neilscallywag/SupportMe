...
class CampaignDAO
{
    public function fetch_campaign($campaign_id)
    {
        ...
        $sql = "SELECT starter_id as user_id,c_title,c_description,c_picture,updatedAt from campaign where campaign_id= :cid";
    ...
    public function search_campaign($campaign_name)
    {
        ...
        $sql = "SELECT starter_id,c_title,c_description,c_picture,updatedAt from campaign where c_title like :cname";
        $stmt = $pdo->prepare($sql);
